...
public class BinaryGapTest {
    ...
    public void expected_5() {
        int expected = 5;
        testEquals("1000001", expected);
        testEquals("10000010", expected);
        testEquals("010000010", expected);
        testEquals("1000010000010", expected);
        testEquals("1010010000100000100000100010010", expected);
    }
    
    @Test
    public void expected_28() {
        int expected = 28;
        testEquals("1100000000000000000000000000001", expected);
    }
